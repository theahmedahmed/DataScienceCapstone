...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df['count'] = [1] * filtered_df.shape[0]
        filtered_df = filtered_df.groupby(['class'], as_index=False).sum()
...
def get_scatter_chart(entered_site, selected_range):
    filtered_df = spacex_df
    filtered_df = filtered_df[filtered_df['Payload Mass (kg)'] >= selected_range[0]]
    filtered_df = filtered_df[filtered_df['Payload Mass (kg)'] <= selected_range[1]]
    fig = None
